...
// Resgatar
// var btnRescueTrash = document.querySelector('#')
...
// // Deletes
// var btnDeleteTrash = document.querySelector('#btnDeleteTrash');

// // AJAX delete
// btnDeleteTrash.addEventListener("click", function(event){
//     event.preventDefault(); 

//     fetch('/trash/delete/:id', {method: DELETE}).then(()=>{
